        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          <div>
            ...
            <div className="space-y-6">
              ...
              <p className="font-sans text-base text-muted-foreground leading-relaxed">I've worked closely with HR teams, through podcasts, events and field conversations, to understand their constraints, priorities, and decision-making.</p>
          ...
          <div className="bg-secondary p-8 md:p-10 rounded-2xl border border-border">
            ...
            <h3 className="font-display text-2xl font-semibold text-foreground mb-6">Why twōakt?</h3>
            
            <div className="space-y-4">
              <p className="font-sans text-base text-muted-foreground leading-relaxed">
                Act One was about listening, learning, and understanding HR.
              </p>
              <p className="font-sans text-base text-muted-foreground leading-relaxed">Act Two is about acting: turning insight into structure, momentum, and results.</p>
              <p className="font-sans text-lg text-foreground font-medium mt-6">twōakt. is where experience meets action.</p>
            </div>
          </div>
        </div>
      </div>
